...
class Updatedb:
    ...
    def updateattndata(self):
        ...
        with open(f"staffattendance/{date}.csv") as csv_file:
            next(csv_file)
        ...
        query = "INSERT INTO `host_attendance` (userid, staffid, datestamp, timestamp, status) VALUES (%s, %s, %s, %s, %s)"
    ...
    def updatealertdata(self):
        ...
        with open(f"staffalerts/{date}.csv") as csv_file:
            next(csv_file)
            csvfile = csv.reader(csv_file, delimiter=',')
        ...
        query = "INSERT INTO `host_alerts` (userid, staffid, datestamp, timestamp) VALUES (%s, %s, %s, %s)"
