...
from studentattendance import Attendance
from studentfacerecognition import Face_Recognition
from studentmaskdetector import Mask_Recognition
from studenttrain import Train
from studentupdatedb import Updatedb
...
class Face_Recognition_System:
    def __init__(self,root):
        ...
        img=Image.open(r"img\studentmain.jpg")
        ...
        b1 = tkinter.Button(root, text = 'Student Details',command=self.student_details, activeforeground="#ffffff",activebackground='#101820',bd=0, bg='#101820', fg="#ffffff", relief=FLAT, font=("calibri", 15))
